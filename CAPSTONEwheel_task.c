...
#pragma config(Motor,  port5,           flashlight,    tmotorServoContinuousRotation, openLoop, reversed)  
...
task main()
{
	...
	while(true){ //always be runnin'
		turnLEDOn(flashlight);
		beltRun(31.5); //void to run the conveyor belt at 1/4 full speed
